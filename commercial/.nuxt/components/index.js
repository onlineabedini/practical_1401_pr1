...
export { default as SecondImgCard } from '../../components/second_img_card/index.vue'
export { default as SecondImgCardSingleImgCard } from '../../components/second_img_card/single_img_card.vue'
...
export const LazySecondImgCard = import('../../components/second_img_card/index.vue' /* webpackChunkName: "components/second-img-card" */).then(c => wrapFunctional(c.default || c))
export const LazySecondImgCardSingleImgCard = import('../../components/second_img_card/single_img_card.vue' /* webpackChunkName: "components/second-img-card-single-img-card" */).then(c => wrapFunctional(c.default || c))
