...
const components = {
  ...
  SecondImgCard: () => import('../../components/second_img_card/index.vue' /* webpackChunkName: "components/second-img-card" */).then(c => wrapFunctional(c.default || c)),
  SecondImgCardSingleImgCard: () => import('../../components/second_img_card/single_img_card.vue' /* webpackChunkName: "components/second-img-card-single-img-card" */).then(c => wrapFunctional(c.default || c)),
