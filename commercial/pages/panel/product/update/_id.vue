        ...
        <div class="main_div p-5">
            ...
            <div class="info_div rtl">
                <form>
                    ...
                    <button type="button" class="btn btn-primary" @click="update_product()">بروزرسانی محصول</button>
...
export default {
    ...
    methods: {
        ...
        update_product() {
            this.$axios.put('/product/update/' + this.product_data._id, this.product_data).then(
                (res) => {
        ...
        delete_data(){
            this.$axios.delete('/product/delete/' + this.product_data._id).then(
                res => {
