<template>
  <div>
    <div class="pt-5 mx-4 pb-3">
      <h2>ارسال تیکت</h2>
    </div>
    <div class="shadow-lg p-3 mb-5 bg-body rounded mx-4 pt-2">
      <p class="pt-5 mx-4">
        برای ارسال درخواست پشتیبانی و یا سوالات قبل از خرید، می توانید از فرم
        ارسال تیکت استفاده کنید
      </p>
      <div class="d-flex justify-content-end mx-4">
        <a href="https://elementorfa.ir/dashboard/tickets/"
          class="text-decoration-none text-white btn btn-success mx-2 pt-2">
          مشاهده همه تیکت ها
        </a>
      </div>
      <div class="d-flex justify-content-start mx-4 pt-3">
        <p>لطفا به نکات زیر توجه فرمایید :</p>
      </div>
      <div class="shadow-sm p-3 mb-5 bg-body rounded mx-4 border-end border-danger ">
        <p class="d-flex justify-content-start mx-4 pt-2"> پس از ارسال تیکت حداکثر بین 1 تا ۱۲ ساعت آینده پاسخ برای شما ارسال خواهد شد.</p>
        <p class="d-flex justify-content-start mx-4 pt-2">برخی از تیکت ها ممکن است، نیاز به زمان بیشتری برای بررسی داشته باشند.</p>
        <p class="d-flex justify-content-start mx-4 pt-2"> پس از ارسال تیکت، نیازی به تماس تلفنی نیست. تیکت ارسالی شما قطعا توسط همکاران ما بررسی و پاسخ داده خواهد شد.</p>
      </div>
    </div>
    <div class="shadow-lg p-3 mb-5 bg-body rounded mx-4 pt-2">
      <div class="row bg-white m-0">
        <div class="col-4">
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="لطفا ایمیل خود را وارد کنید" />
          </div>
        </div>
        <div class="col-5">
          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">نام</label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="لطفا نام خود را وارد کنید" />
          </div>
        </div>
      </div>
